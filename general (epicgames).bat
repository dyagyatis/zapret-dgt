...
--filter-tcp=80,443,4433,15000-15050,25000-25050 --hostlist="%LISTS%list-general.txt" --dpi-desync=fake --new
--filter-udp=1024-65535 --hostlist="%LISTS%list-general.txt" --dpi-desync=fake --dpi-desync-any-protocol=1 --new
